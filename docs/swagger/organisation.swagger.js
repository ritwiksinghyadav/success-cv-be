...
/**
 * @swagger
 * /api/v1/organisations/{id}/candidates:
 *   get:
 *     summary: Get all candidates for an organisation
 *     tags: [Organisation]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Organisation candidates retrieved successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: Organisation candidates retrieved successfully
 *                 data:
 *                   type: array
 *                   items:
 *                     type: object
